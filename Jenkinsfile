        ...
        stage('SSH') {
            steps {
                script {
                    ...
                    ssh -o StrictHostKeyChecking=no -i "**~/.ssh/sshforservers.pem**" ubuntu@3.126.50.23 "docker pull rodzhev/firstdemo:latest" "docker run -t -d --name firstdemo -p 5000:5000 rodzhev/firstdemo:latest"
